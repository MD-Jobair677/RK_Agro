...
Route::middleware('admin')->group(function () {
    ...
    Route::name('account.')->group(function () {
        ...
        Route::controller('GeneralExpenseController')->prefix('manage/general/expenses')->name('gen_expns.')->group(function () {
            Route::get('/', 'index')->name('index');
    ...
    Route::controller('inventoryController')->prefix('manage/inventory')->name('inventory.')->group(function () {
        Route::get('/stocks', 'stockIndex')->name('stock.index');
        ...
        Route::get('issue/create', 'create')->name('issue.create');
