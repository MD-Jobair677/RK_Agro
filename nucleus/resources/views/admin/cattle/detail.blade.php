                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="col-form-label">@lang('Purchase Price')</label>
                                                <input type="number" min="0" step="0.01" class="form-control"
                                                    step="any" name="purchase_price"
                                                    value="{{ $cattle->purchase_price }}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="total_gen_exp"
                                                    disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="total_med_cost"
                                                    disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 mb-3">
                                        ...
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" step="0.01" class="form-control"
                                                    ...
                                                    value="{{ $cattle->purchase_weight }}"
                                                    placeholder="@lang('Enter your weight')" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
...
@push('page-script')
    <script>
        ...
        $('.cal_est_cost').on('click', function(e) {
            ...
            let genExpense = 0;
            let grandTotal = 0;
            console.log(cattleData.last_cattle_record, cattleCategory, genExpnObj);
